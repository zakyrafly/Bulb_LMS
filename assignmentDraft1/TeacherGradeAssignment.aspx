<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherGradeAssignment.aspx.cs" Inherits="assignmentDraft1.TeacherGradeAssignment" %>
...
<section class="grade-management">
    ...
    <div class="assignment-header">
        ...
        <div style="background: var(--light-bg); padding: 1rem; border-radius: .5rem; border-left: 4px solid var(--main-color);">
    ...
    <div class="controls-section">
        <div>
            <a href="assignments.aspx" class="option-btn">
            ...
            <ItemTemplate>
                <div class="submission-card">
                    ...
                    <div class="submission-body">
                        <%# Eval("SubmissionDate") != DBNull.Value ? assignmentDraft1.TeacherGradeAssignment.GetSubmissionContent(Container.DataItem) : assignmentDraft1.TeacherGradeAssignment.GetNoSubmissionContent() %>
                        
                        <!-- Grading Section -->
                        <div class="grading-section">
                            <%# Eval("PointsEarned") != DBNull.Value ? assignmentDraft1.TeacherGradeAssignment.GetCurrentGradeDisplay(Eval("PointsEarned"), Eval("MaxPoints"), Eval("Feedback")) : "" %>
                            
                            <div class="grading-form">
                                <div class="form-group">
                                    <label>Points Earned</label>
                                    <asp:TextBox runat="server" CssClass="grade-input" TextMode="Number" 
                                               placeholder="Enter points (0-100)" min="0" max="100"
                                               ID="txtPoints" 
