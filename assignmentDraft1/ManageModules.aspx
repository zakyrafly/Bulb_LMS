<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageModules.aspx.cs" Inherits="assignmentDraft1.ManageModules" %>
...
<head runat="server">
    ...
    <title>Manage Modules - Bulb</title>
...
<body>
        ...
        <div class="main-content">
            ...
            <div class="page-header">
                ...
                <div class="course-info">
                    ...
                    <div>
                        <a href="TeacherWebform.aspx" class="btn">
    ...
    <script>
        ...
        function validateForm() {
            const title = document.getElementById('<%= txtModuleTitle.ClientID %>').value.trim();
            const description = document.getElementById('<%= txtModuleDescription.ClientID %>').value.trim();
            const order = document.getElementById('<%= txtModuleOrder.ClientID %>').value.trim();

            if (!title) {
                showMessage('Please enter a module title', 'error');
                return false;
            }
            ...
            if (!description) {
                showMessage('Please enter a module description', 'error');
                return false;
            }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('ManageModules page loaded successfully');
