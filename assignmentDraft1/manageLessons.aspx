<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageLessons.aspx.cs" Inherits="assignmentDraft1.ManageLessons" %>
...
<head runat="server">
    ...
    <title>Manage Lessons - Bulb</title>
        ...
        <div class="main-content">
            ...
            <div class="page-header">
                <div class="breadcrumb">
                    ...
                    <span> / </span>
                    <a href='<%# "EditModules.aspx?courseId=" + Request.QueryString["courseId"] %>'><i class="fas fa-th-list"></i> Edit Modules</a>
                    <span> / </span>
                ...
                <div class="module-info">
                    ...
                    <div>
                        <a href='<%# "EditModules.aspx?courseId=" + Request.QueryString["courseId"] %>' class="btn">
                            <i class="fas fa-arrow-left"></i> Back to Edit Modules
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div id="lessonModal" class="modal">
            <div class="modal-content">
                ...
                <div style="margin-top: 2rem; text-align: right;">
                    ...
                    <asp:Button ID="btnSaveLesson" runat="server" Text="Save Lesson" CssClass="btn" OnClick="BtnSaveLesson_Click" style="background-color: var(--main-color);" />
                </div>
            </div>
        </div>
